...
explore_html = _read(os.path.join(BASE_DIR, "sites/explore/index.html"))
user_profile_html = _read(os.path.join(BASE_DIR, "sites/user/index.html"))
project_html = _read(os.path.join(BASE_DIR, "sites/project/index.html"))
